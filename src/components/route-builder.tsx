...
export function RouteBuilder({
  ...
  return (
    ...
    <div className="space-y-4">
      {/*
        Where am I starting, before where am I going. This used to sit in the
        right-hand column, which on a phone stacks *below* the map — so the
        first question the route answers appeared after the answer.
      */}
