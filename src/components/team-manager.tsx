...
function RevokeButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="tap-target min-h-10 shrink-0 rounded-xl border border-white/10 px-3 text-xs font-semibold text-slate-300 disabled:opacity-60"
    >
    ...
    <div className="space-y-4">
      <section className="rounded-3xl border border-white/10 bg-[#0b1b27] p-5 sm:p-6">
        ...
        <ul className="mt-4 space-y-2">
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="block truncate text-sm font-semibold">
                  ...
                  {member.isMe ? <span className="ml-2 text-xs text-slate-500">you</span> : null}
                </span>
          ...
          {members.length === 0 ? (
            <li className="rounded-2xl border border-white/10 p-4 text-sm text-slate-400">
              Only you, for now.
            </li>
          ) : null}
        </ul>
