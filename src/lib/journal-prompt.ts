...
export function journalSystemPrompt(input: {
  ...
  return [
    ...
    "",
    "Write the way somebody talks who has done this a thousand times and is explaining it to a neighbour over a fence. Short sentences. Ordinary words. A trade term is fine the moment after you have said what it means.",
    "",
